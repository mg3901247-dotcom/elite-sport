document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateLightbox() {
    ...
    lightboxCaption.innerHTML = `${title} <span style="opacity: 0.7; font-size: 1rem; font-weight: normal;">— ${subtitle}</span>`;
...
}); // ✅ قفل DOMContentLoaded الخاص بأزرار الـ Scroll